...
function ProductCard({ product }: Iproducts) {
  ...
  return (
    <div className='w-32 md:w-44 lg:w-48 border border-solid border-gray-700 mx-2 my-4 font-inter hover:shadow-lg'>
        ...
        <div className='flex flex-col md:flex-row justify-between p-2 border-t border-solid border-gray-700 space-y-2 md:space-x-2 md:space-y-0'>
